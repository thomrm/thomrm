    ...
    <div class="app-wrapper" class:light={!dark} class:dark={dark}>
        <div class="page-header" in:fade={{delay: 200, duration: 200}}>
            ...
            {#if nav}
                <nav class="page-nav--vertical" transition:fade={{ duration: 100 }}>
                    <a href="/" aria-current={$page.url.pathname === '/'} on:click={toggleNav}>About</a>
                    <a href="/skills" aria-current={$page.url.pathname === '/skills'} on:click={toggleNav}>Skills</a>
                    <a href="/projects" aria-current={$page.url.pathname === '/projects'} on:click={toggleNav}>Projects</a>
                    <a href="/contact" aria-current={$page.url.pathname === '/contact'} on:click={toggleNav}>Contact</a>
                </nav>
            {/if}
        </div>
        ...
        <footer class="page-footer" in:fade={{delay: 200, duration: 200}}>
            ...
            <div class="made-by">
                ...
                <a href="http://figma.com" alt="Figma">
                ...
                <span>and</span>
                <a href="http://svelte.dev" alt="Svelte">
